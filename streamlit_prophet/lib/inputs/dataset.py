...
def input_dataset(
    ...
    """Silahkan upload dataset deret waktu yang akan dianalisa. Lets the user decide whether to upload a dataset or download a toy dataset.
    ...
    load_options["toy_dataset"] = st.checkbox(
        "Gunakan Data Sampel", False, help=readme["tooltips"]["upload_choice"]
    )
    if load_options["toy_dataset"]:
        dataset_name = st.selectbox(
            "Pilih sampel dataset",
